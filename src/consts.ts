...
export const CREATIONS: Metadata = {
  TITLE: "Creations",
  DESCRIPTION:
    "A collection of my creations, with links to repositories and demos.",
};
...
export const POEMS: Metadata = {
  TITLE: "Poem",
  DESCRIPTION:
    "At some point I started writing poetry.<br/> I even like some of it.",
};

export const SOCIALS: Socials = [
  {
    NAME: "github",
    HREF: "https://github.com/recursivepaws",
  },
  {
    NAME: "linkedin",
